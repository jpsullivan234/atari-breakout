...
HD_PWD='C:/Users/jsullivan4/video_test/video_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log take2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source take2_wrapper.tcl
