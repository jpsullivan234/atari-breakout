...
HD_PWD='C:/Users/jsullivan4/video_test/video_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log take2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source take2_wrapper.tcl -notrace
