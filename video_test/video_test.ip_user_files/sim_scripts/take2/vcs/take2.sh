...
design_libs=(xpm xil_defaultlib microblaze_v11_0_13 lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_24 blk_mem_gen_v8_4_8 generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_32 fifo_generator_v13_2_10 axi_data_fifo_v2_1_31 axi_crossbar_v2_1_33 axi_lite_ipif_v3_0_4 mdm_v3_2_26 lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 interrupt_control_v3_1_5 axi_gpio_v2_0_34 lib_pkg_v1_0_4 axi_timer_v2_0_34)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  "../../../bd/take2/ip/take2_lmb_bram_1/sim/take2_lmb_bram_1.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  "../../../../video_test.gen/sources_1/bd/take2/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  "../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  "../../../../video_test.gen/sources_1/bd/take2/ipshared/676c/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  ...
  vlogan -work axi_data_fifo_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  "../../../../video_test.gen/sources_1/bd/take2/ipshared/2ccb/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_33 $vlogan_opts +v2k +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/ec67/hdl" +incdir+"../../../../video_test.gen/sources_1/bd/take2/ipshared/3242" \
  ...
  vhdlan -work axi_timer_v2_0_34 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.take2 xil_defaultlib.glbl -o take2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./take2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key take2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc take2_simv.daidir vcs_lib c.obj)
