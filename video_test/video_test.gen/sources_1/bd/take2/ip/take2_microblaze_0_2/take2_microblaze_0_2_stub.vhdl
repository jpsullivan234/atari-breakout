...
-- Date        : Wed Dec  4 12:03:03 2024
-- Host        : MDD-ECE-HHPG853 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top take2_microblaze_0_2 -prefix
--               take2_microblaze_0_2_ take2_microblaze_0_1_stub.vhdl
-- Design      : take2_microblaze_0_1
...
entity take2_microblaze_0_2 is
  Port ( 
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
...
end take2_microblaze_0_2;

architecture stub of take2_microblaze_0_2 is
...
attribute x_core_info of stub : architecture is "MicroBlaze,Vivado 2024.1.1";
begin
end;
